  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>
            <span className="font-light font-notojp">
              Modificar / Eliminar asignaturas
            </span>
            <p className="text-xs font-light uppercase mt-2 text-red-200">
              <span className="font-bold">atención</span>, este proceso modifica todas las dependencias, alumnos y notas asociadas a estas asignaturas
              <br />
        ...
        {!confirmado ? (
          <div className="space-y-4 mt-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => setConfirmado(true)} className="font-light uppercase text-xs">Sí, adelante</Button>
            </div>
          </div>
        ) : (
          <>
