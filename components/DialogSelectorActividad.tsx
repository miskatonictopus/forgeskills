        ...
        <div className="p-6">
          <DialogHeader className="text-left">
            ...
            <DialogDescription id={descId}>
              Elige cómo quieres crear tu actividad. Introduce tu actividad manualmente o crea una actividad mediante LLM + Heuristic Method.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Card
              ...
              onKeyDown={(e) => {
                if (e.key === "Enter" || e.key === " ") handleSelect("manual");
              }}
              className="cursor-pointer hover:shadow-md transition-all rounded-2xl border-muted bg-card/60"
            >
              ...
              <CardContent className="text-xs text-muted-foreground">
                Si ya tienes tu actividad en mente, tan sólo escríbela o sube tu archivo, el sistema te detectará los CE automáticamente o podrás seleccionarlos manualmente
              </CardContent>
            </Card>
            ...
            <Card
              ...
              className={cn(
                "cursor-pointer hover:shadow-md transition-all rounded-2xl border-muted bg-card/60",
                disableLLM && "opacity-60 pointer-events-none"
              )}
            >
              <CardHeader className="space-y-2">
                <div className="flex items-center gap-2">
                  <WandSparkles className="h-5 w-5" aria-hidden />
                  <CardTitle className="text-base">Crear mediante LLM + H</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="text-xs text-muted-foreground">
                Selecciona los CE para los que quieres crear la actividad, el tiempo de actividad y tu metología preferida y nuestro sistema creará una actividad a medida{" "}
